...
The application is split into two modules: backend and frontend.
...
For convenience, a root [package.json](package.json) is provided that allows building and running the application
...
we will pose some additional requirements, constraining those details further, along with an explanation of said requirement.
...
The backend uses the maven plugin [openapi-generator-maven-plugin](https://github.com/OpenAPITools/openapi-generator/tree/master/modules/openapi-generator-maven-plugin)
to generate the client code., whereas the frontend uses the npm package [openapi-generator-cli](https://www.npmjs.com/package/openapi-generator-cli).
